...
def robot1_2x3_mdp():
    ...
    m = nx.DiGraph()
    m.graph['name'] = 'robot1'
    m.add_node('00', player=1, ap=['00'])
    m.add_node('01', player=1, ap=['00'])
    m.add_node('02', player=1, ap=['00'])
    m.add_node('10', player=1, ap=['10'])
    m.add_node('11', player=1, ap=['10'])
    m.add_node('12', player=1, ap=['01'])
    ...
    # graph information
    m.graph['init'] = '00'
    m.graph['ap'] = ["CRITA", "GOALA"]  # all uppercase required, order sensitive
...
def robot2_2x3_mdp():
    ...
    m = nx.DiGraph()
    m.graph['name'] = 'robot2'
    m.add_node('00', player=1, ap=['01'])
    m.add_node('01', player=1, ap=['00'])
    m.add_node('02', player=1, ap=['00'])
    m.add_node('10', player=1, ap=['10'])
    m.add_node('11', player=1, ap=['10'])
    m.add_node('12', player=1, ap=['00'])
    ...
    # graph information
    m.graph['init'] = '12'
    m.graph['ap'] = ["CRITB", "GOALB"]  # all uppercase required, order sensitive
